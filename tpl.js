...
var __PARSE__ = (function() {
    ...
    var regmap = [
        ...
        {reg: /^list\s+([\S]+)\s+as\s+([\S]+)/i, val: function(all, arr, item) {
            ...
            var varName = '__INDEX_' + autoVarName() + '__';
            return 'for(var ' + varName + '=0;' + varName + '<' + arr + '.length;' + varName + '++) {var ' + item + '=' + arr + '[' + varName + '];var ' + item + '_index=' + varName + ';';
        }},
        // list语句结束
        {reg: /^\/\s*list/i, val: '}'},
        // var 语句
